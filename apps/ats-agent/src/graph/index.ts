...
import { extractKeywordsNode } from './nodes/extractKeywords'
...
const GraphAnnotation = Annotation.Root({
  ...
  cvKeywords: Annotation<string[] | undefined>({
    reducer: (_, update) => update,
    default: () => undefined,
  }),
  keywordGaps: Annotation<string[] | undefined>({
    reducer: (_, update) => update,
    default: () => undefined,
  }),
...
const graph = new StateGraph(GraphAnnotation)
  ...
  .addEdge('mapper', 'extractKeywords')
  .addEdge('extractKeywords', 'jdKeywordExtractor')
