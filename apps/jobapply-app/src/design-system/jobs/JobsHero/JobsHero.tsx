...
export function JobsHero({ search, totalCount, onSearchChange, onSubmit }: JobsHeroProps) {
    ...
    <section className={styles.hero}>
      <div className={styles.inner}>
        <p className={styles.eyebrow}>
          {t('jobs.hero.eyebrow', { count: totalCount, defaultValue: `${totalCount} vagas disponíveis` })}
        </p>
        <HeroSearchForm
          search={search}
